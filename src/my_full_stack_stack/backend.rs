...
impl Backend {
    pub fn new(stack: &aws_cdk_lib::Stack, database_endpoint: String, lambda_zip_path: String) -> Self {        
        let bundled_code = aws_lambda::Code::from_asset(
            lambda_zip_path.to_string(),
            None
        );
        ...
        lambda.add_to_role_policy(&aws_iam::PolicyStatement::new(Some(aws_iam::PolicyStatementProps {
        ...
        let lambda_function_url = lambda.add_function_url(
